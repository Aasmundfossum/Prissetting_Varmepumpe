...
class cost_heatpump:
    ...
    def run_all_without_streamlit(self):
        ...
        self.show_results_non_streamlit()
    ...
    def find_correct_price(self):
        ...
        print(self.type_of_HP2)
        

    def read_datasheet_excel(self):
        leveransetemp_str = self.delivered_temp_DUT.replace(' \u2103','')
        
        self.hp_name2 = None

        if self.type_of_HP2 == '1x Steel 55.4':
            self.number_of_hp = 1
            self.hp_name = f'STEEL 55.4 {leveransetemp_str}'
            self.hp_power = '50'
        elif self.type_of_HP2 == '1x IRON 120.2':
            self.number_of_hp = 1
            self.hp_name = f'IRON 120.2 {leveransetemp_str}'
            self.hp_power = '100'
        elif self.type_of_HP2 == '1x IRON 170.2':
            self.number_of_hp = 1
            self.hp_name = f'IRON 170.2 {leveransetemp_str}'
            self.hp_power = '150'
            ...
            self.hp_name2 = f'IRON 170.2 {leveransetemp_str}'
            ...
            self.number_of_hp = 2
            self.hp_name = f'IRON 200.2 {leveransetemp_str}'
            self.hp_power = '2x175'
        elif self.type_of_HP2 == '3x IRON 150.2':
            self.number_of_hp = 3
            self.hp_name = f'IRON 150.2 {leveransetemp_str}'
            self.hp_power = '3x133'
    ...
    def show_results_non_streamlit(self):
        print('')
        print('RESULTATER:')
...
#cost_heatpump().run_all_without_streamlit()